...
def display_text(size:int,text:str,screen:pg.Surface,colour:list[int,int,int]|tuple[int,int,int],font:str = "Arial",*,
...
def display_multi_line_text(size:int,text:str,screen:pg.Surface,colour:list[int,int,int]|tuple[int,int,int],font:str = "Arial",*,
    ...
    if center_pos:
        ...
        pos = (center_pos.x-(text.get_rect().width/2), center_pos.y-(text.get_rect().height/2)-(len(lines)*size/2))
    elif top_left_pos:
        pos = (top_left_pos.x, top_left_pos.y)
    else:
        pos = (0,0)
